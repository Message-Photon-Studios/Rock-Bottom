...
public class CheckWall : Node
{
    ...
    {
        bool test = Physics2D.Raycast(stats.GetPosition()+ Vector2.up*yPos, new Vector2(direction.x*stats.lookDir, direction.y), distance, ~LayerMask.GetMask("Enemy", "Player", "Spell"));
